...
const steps = ["Safety", "Project", "Property", "Appliances", "Supply", "Route", "Protection", "Access", "Contact"];
...
export default function LpgAssessment() {
  ...
  const requiredByStep = ["emergency", "work", "property", "appliances", "cylinders", "distance", "detector", "restrictions", "city"];
